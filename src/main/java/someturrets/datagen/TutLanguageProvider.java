...
import static someturrets.blocks.ScreenBlock.MESSAGE_SCREEN;
...
public class TutLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(MESSAGE_SCREEN, "Displays several states around the processing facility");
        add(SCREEN_SOMETURRETS_POWERGEN, "Power generator");

        add(Registration.SCREEN.get(), "Screen");
        ...
        add(Registration.BEDROCK_REINFORCED_STEEL_INGOT.get(), "Bedrock Reinforced Steel Ingot");
